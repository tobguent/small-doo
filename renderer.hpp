...
class Renderer
{
	public:
		...
		{
			char* blobLineShader_HQ, *blobLineShader_LowRes, *blobMinGather_LowRes, *blobRenderFragments, *blobSortFragments, *blobSortFragmentsLowRes;
			UINT sizeLineShader_HQ, sizeLineShader_LowRes, sizeMinGather_LowRes, sizeRenderFragments, sizeSortFragments, sizeSortFragmentsLowRes;
